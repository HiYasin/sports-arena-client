...
const Services = () => {
    ...
    return (
        <>
            ...
            {/* table */} 
            <table className="table-auto w-full bg-base-100 rounded-2xl overflow-hidden">
                <thead>
                ...
                <tbody>
                    {products && products.map((product, index) => (
                        <tr key={index}>
                            ...
                            <td className="border border-gray-400 px-4 py-2">{product.itemName}</td>
                            ...
                            <td className="border border-gray-400 px-4 py-2">{product.rating}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
